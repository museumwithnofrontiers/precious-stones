...
The **Museum With No Frontiers — Precious Stones** gallery, built from the published
dataset `@museumwnf/precious-stones-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/precious-stones-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/precious-stones/> through the reusable workflows in
