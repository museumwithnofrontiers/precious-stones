...
// `useGalleryData.js` used to be byte-identical local copies of what precious-stones
...
// legacy project key, no UUID — precious-stones shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (precious-stones-data 1.0.11+), an outside
