...
const about = {
  body: 'preciousStones.about.body',
...
export default {
  ...
  home: {
    title: 'preciousStones.identity.title',
    intro: 'preciousStones.home.intro',
    cards: [
      {
        title: 'preciousStones.nav.catalogue',
        description: 'preciousStones.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'preciousStones.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'preciousStones.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'preciousStones.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'preciousStones.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'preciousStones.partnerObjects.emptyPartner',
  //         emptyInstitution: 'preciousStones.partnerObjects.emptyInstitution',
  //         institutionSummary: 'preciousStones.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'preciousStones.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'preciousStones.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
